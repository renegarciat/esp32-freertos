...
void vTimerCallback(TimerHandle_t pxTimer)
{
    ...
    speed = 60 * (pulses / 2.0); // Calculate speed in turns per second
    printf("Speed: %.2f rpm\n", speed);
...
void app_main(void)
{
    ...
    xTaskCreate(&http_patch_task, "http_patch_task", 8192, NULL, 5, NULL);
    xTaskCreate(button_task, "button_task", 4096, NULL, 20, &ISR);
